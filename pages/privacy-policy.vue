<template>
      <div data-custom-class="body" style="padding:32px;">
    <div>
      <strong
        ...
        <strong>
          <span style="font-size: 15px">
            <span data-custom-class="subtitle">
              Last updated
              <span class="question">January 22, 2023</span>
            </span>
          </span>
        </strong>
      </span>
        ...
        <span style="font-size: 15px">
          <span style="color: rgb(127, 127, 127)">
            <span data-custom-class="body_text">
              ...
              <span class="question">first.bite.app@gmail.com</span>
              .
            </span>
          </span>
        </span>
    ...
    <div style="line-height: 1.5">
      ...
      <div style="line-height: 1.5">
        <span style="font-size: 15px">
          <span data-custom-class="body_text">
            ...
            <span class="block-component"></span>
            <span class="question">The FirstBite</span>
            <span class="statement-end-if-in-editor"></span>
      ...
      <div style="line-height: 1.5">
        ...
        <a
          ...
          href="https://app.termly.io/notify/9afc2671-eae5-4301-8a71-64a337c9ec80"
      ...
      <div style="line-height: 1.5">
        <span style="font-size: 15px">
          <a data-custom-class="link" href="#infominors"
            ><span style="color: rgb(89, 89, 89)"
              >7. DO WE COLLECT INFORMATION FROM MINORS?</span
            ></a
          >
          <span style="color: rgb(127, 127, 127)">
            <span style="color: rgb(89, 89, 89)">
      ...
      <div style="line-height: 1.5">
        <a data-custom-class="link" href="#virginia"
          ><span style="font-size: 15px"
            >11. DO VIRGINIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</span
          ></a
        >
        <span style="font-size: 15px">
          <span class="statement-end-if-in-editor"
          ...
          <span style="font-size: 15px; color: rgb(89, 89, 89)">
            <span style="font-size: 15px; color: rgb(89, 89, 89)">
              <span data-custom-class="body_text">
                <span style="font-size: 15px">
                  <span data-custom-class="body_text">
                    <span class="question">phone numbers</span>
                  </span>
                </span>
              </span>
            </span>
          ...
          <span style="font-size: 15px; color: rgb(89, 89, 89)">
            <span style="font-size: 15px; color: rgb(89, 89, 89)">
              <span data-custom-class="body_text">
                <span style="font-size: 15px">
                  <span data-custom-class="body_text">
                    <span class="question">mailing addresses</span>
                  </span>
                </span>
              </span>
            </span>
          ...
          <span style="font-size: 15px; color: rgb(89, 89, 89)">
            <span style="font-size: 15px; color: rgb(89, 89, 89)">
              <span data-custom-class="body_text">
                <span style="font-size: 15px">
                  <span data-custom-class="body_text">
                    <span class="question">job titles</span>
                  </span>
                </span>
              </span>
            </span>
          ...
          <span style="font-size: 15px; color: rgb(89, 89, 89)">
            <span style="font-size: 15px; color: rgb(89, 89, 89)">
              <span data-custom-class="body_text">
                <span style="font-size: 15px">
                  <span data-custom-class="body_text">
                    <span class="question">contact preferences</span>
                  </span>
                </span>
              </span>
            </span>
          ...
          <span style="font-size: 15px; color: rgb(89, 89, 89)">
            <span style="font-size: 15px; color: rgb(89, 89, 89)">
              <span data-custom-class="body_text">
                <span style="font-size: 15px">
                  <span data-custom-class="body_text">
                    <span class="question">contact or authentication data</span>
                  </span>
                </span>
              </span>
            </span>
      ...
      <ul>
        <li style="line-height: 1.5">
          <span style="font-size: 15px">
            <span data-custom-class="body_text">
              <span class="question"
                >data about a person's sex life or sexual orientation</span
              >
            </span>
          </span>
        </li>
        ...
        <span style="font-size: 15px; color: rgb(89, 89, 89)">
          <span style="font-size: 15px; color: rgb(89, 89, 89)">
            <span data-custom-class="body_text">
              ...
              <span class="question">Stripe</span>
              <span style="font-size: 15px; color: rgb(89, 89, 89)">
                <span style="font-size: 15px; color: rgb(89, 89, 89)">
                  <span data-custom-class="body_text">
                    <span style="font-size: 15px; color: rgb(89, 89, 89)">
        ...
        <span style="font-size: 15px; color: rgb(89, 89, 89)">
          <span style="font-size: 15px; color: rgb(89, 89, 89)">
            <span data-custom-class="body_text">
              ...
              <span class="block-component"></span>"
              <span class="statement-end-if-in-editor"></span> below.
            </span>
          </span>
        </span>
      </div>
        ...
        <li style="line-height: 1.5">
          <span style="font-size: 15px">
            <span data-custom-class="body_text">
              ...
              <span class="forloop-component"></span>
              <span class="question">social media accounts</span>,
              <span class="forloop-component"></span>
              <span class="question">microphone</span>,
              <span class="forloop-component"></span>
              <span class="question">camera</span>,
              <span class="forloop-component"></span>
              <span class="question">storage</span>,
              <span class="forloop-component"></span>
          ...
          <span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span style="font-size: 15px; color: rgb(89, 89, 89)"
              ><span data-custom-class="body_text"
                ...
                about your activity in the Services<span
                ...
                <span class="block-component"></span>"crash dumps"<span
                  class="statement-end-if-in-editor"
                ></span
          ...
          <span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span style="font-size: 15px; color: rgb(89, 89, 89)"
              ><span data-custom-class="body_text"
                ...
                system configuration information.<span style="font-size: 15px"
                  ><span style="color: rgb(89, 89, 89)"
                    ><span data-custom-class="body_text"
                      ><span style="font-size: 15px"
                        ><span style="color: rgb(89, 89, 89)"
              ...
              <span style="color: rgb(89, 89, 89)">
                <span style="font-size: 15px">
                  <span data-custom-class="body_text">
                    ...
                    ,
                    <span class="statement-end-if-in-editor"></span>
                    Facebook or Twitter), we receive personal information about
                    you such as your name, email address, and gender. Any
                ...
                <span style="color: rgb(89, 89, 89)">
                  ...
                  <span data-custom-class="body_text">
                    <span style="font-size: 15px">
                      <span style="color: rgb(89, 89, 89)">
                        <span class="block-component"></span>
                        <span class="question">Google account</span>
                        <span class="block-component"></span>
                      </span>
                    </span>
                  </span>
                ...
                <span data-custom-class="body_text">
                  <span style="font-size: 15px">
                    <span style="color: rgb(89, 89, 89)">
                      ...
                      <span style="font-size: 15px">
                        <span style="color: rgb(89, 89, 89)">
                          <span class="question">Facebook account</span>
                  ...
                  <span data-custom-class="body_text">
                    ...
                    and
                    <span class="question">Stripe account</span>
                    <span style="font-size: 15px">
                      <span style="color: rgb(89, 89, 89)">
                        <span style="font-size: 15px">
                          <span style="color: rgb(89, 89, 89)">
      ...
      <ul>
        <li style="line-height: 1.5">
          <span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span style="font-size: 15px; color: rgb(89, 89, 89)"
              ><span data-custom-class="body_text"
                ><strong>Communicate and Chat with Users</strong></span
              ></span
            ></span
          >
        </li>
                ...
                <span style="color: rgb(89, 89, 89)">
                  ...
                  <span data-custom-class="body_text">
                    <span style="font-size: 15px">
                      <span style="color: rgb(89, 89, 89)">
                        <span class="block-component"></span>
                        <span class="question">Firebase Cloud Messaging</span>
                        <span class="block-component"></span>
                      </span>
                    </span>
                  </span>
                ...
                <span style="color: rgb(89, 89, 89)">
                  ...
                  <span data-custom-class="body_text">
                    <span style="font-size: 15px">
                      <span style="color: rgb(89, 89, 89)">
                        <span class="block-component"></span>
                        <span class="question">DigitalOcean </span>
                        <span class="block-component"></span>
                      </span>
                    </span>
                  </span>
      ...
      <ul>
        <li style="line-height: 1.5">
          <span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span style="font-size: 15px; color: rgb(89, 89, 89)"
              ><span data-custom-class="body_text"
                ><strong>Invoice and Billing</strong></span
              ></span
            ></span
          >
        </li>
                ...
                <span data-custom-class="body_text">
                  <span style="font-size: 15px">
                    <span style="color: rgb(89, 89, 89)">
                      ...
                      <span style="font-size: 15px">
                        <span style="color: rgb(89, 89, 89)">
                          <span class="question">Apple Pay</span>
                          <span class="else-block"></span>
                        </span>
                      </span>
                    </span>
                  ...
                  <span data-custom-class="body_text">
                    ...
                    and
                    <span class="question">Google Wallet</span>
                    <span style="font-size: 15px">
                      <span style="color: rgb(89, 89, 89)">
                        <span style="font-size: 15px">
                          <span style="color: rgb(89, 89, 89)">
      ...
      <ul>
        <li style="line-height: 1.5">
          <span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span style="font-size: 15px; color: rgb(89, 89, 89)"
              ><span data-custom-class="body_text"
                ><strong>Web and Mobile Analytics</strong></span
              ></span
            ></span
          >
        </li>
                  ...
                  <span data-custom-class="body_text">
                    <span style="font-size: 15px">
                      <span style="color: rgb(89, 89, 89)">
                        <span class="block-component"></span>
                        <span class="question"
                          >Google Analytics for Firebase</span
                        >
                        <span class="block-component"></span>
                      </span>
                    </span>
      ...
      <ul>
        <li style="line-height: 1.5">
          <span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span style="font-size: 15px; color: rgb(89, 89, 89)"
              ><span data-custom-class="body_text"
                ><strong>Website Performance Monitoring</strong></span
              ></span
            ></span
          >
        </li>
                ...
                <span style="color: rgb(89, 89, 89)">
                  ...
                  <span data-custom-class="body_text">
                    <span style="font-size: 15px">
                      <span style="color: rgb(89, 89, 89)">
                        <span class="block-component"></span>
                        <span class="question">Sentry</span>
                        <span class="block-component"></span>
                      </span>
                    </span>
                  </span>
      ...
      <ul>
        <li style="line-height: 1.5">
          <span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span style="font-size: 15px; color: rgb(89, 89, 89)"
              ><span data-custom-class="body_text"
                ><strong>Website Testing</strong></span
              ></span
            ></span
          >
        </li>
            ...
            <span data-custom-class="body_text">
              <span style="font-size: 15px">
                <span style="color: rgb(89, 89, 89)">
                  ...
                  <span data-custom-class="body_text">
                    <span style="font-size: 15px">
                      <span style="color: rgb(89, 89, 89)">
                        <span class="block-component"></span>
                        <span class="question">TestFlight</span>
                        <span class="block-component"></span>
                      </span>
                    </span>
                  </span>
                ...
                <span data-custom-class="body_text">
                  ...
                  and
                  <span class="question">Google Play Console</span>
                  <span style="font-size: 15px">
                    <span style="color: rgb(89, 89, 89)">
                      <span style="font-size: 15px">
                        <span style="color: rgb(89, 89, 89)">
          ...
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              ><em
                ...
                <span class="block-component"></span>fulfill<span
                  class="statement-end-if-in-editor"
                ></span>
        ...
        <span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              tax, accounting, or other legal requirements).<span
              ...
              <span style="font-size: 15px"
                ><span style="color: rgb(89, 89, 89)"
                  ><span data-custom-class="body_text"
                    ><span class="block-component"></span></span></span></span
              ><span class="block-component"></span
              ><span class="question">three (3)</span> months past the
              termination of the user's account<span
                class="block-component"
              ></span
              ><span style="font-size: 15px"
                ><span style="color: rgb(89, 89, 89)"
                  ><span data-custom-class="body_text"
                    ><span class="else-block"></span></span></span></span
              >.</span
            ></span
          ></span
        >
        ...
        <span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              <span class="block-component"></span>anonymize<span
                class="statement-end-if-in-editor"
              ></span>
          ...
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              ><em
                ...
                <span class="block-component"></span>organizational<span
                  class="statement-end-if-in-editor"
                ></span>
        ...
        <span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              <span class="block-component"></span>unauthorized<span
                class="statement-end-if-in-editor"
              ></span>
          ...
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              ><em>
                ...
                <span class="block-component"></span>children under 18 years of
                age<span class="else-block"></span>.</em
              ><span class="block-component"></span></span></span
        ></span>
      </div>
      <div style="line-height: 1.5"><br /></div>
            ...
            ><span data-custom-class="body_text"
              ...
              <span style="color: rgb(89, 89, 89); font-size: 15px"
                ><span data-custom-class="body_text"
                  ><span class="block-component"></span
                  ><span class="question">first.bite.app@gmail.com</span
                  ><span class="else-block"></span></span></span
              >.</span
            ><span data-custom-class="body_text"
              ><span class="else-block"></span></span></span
        ></span>
            ...
            ><span style="font-size: 15px; color: rgb(89, 89, 89)"
              ><span style="font-size: 15px; color: rgb(89, 89, 89)"
                ><span id="control" style="color: rgb(0, 0, 0)"
                  ><strong
                    ><span data-custom-class="heading_1"
                      >8. WHAT ARE YOUR PRIVACY RIGHTS?</span
                    ></strong
                  ></span
                ></span
              ></span
            ...
            ><span data-custom-class="body_text"
              ...
              ><em>
                <span style="color: rgb(89, 89, 89)"
                  ><span style="font-size: 15px"
                    ><span data-custom-class="body_text"
                      ><em><span class="block-component"></span></em></span
                  ></span> </span
        ...
        <span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              relying on your consent to process your personal information,<span
                class="block-component"
              ></span>
              which may be express and/or implied consent depending on the
              applicable law,<span class="statement-end-if-in-editor"></span>
          ...
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ><span class="block-component"></span>"<span
                class="statement-end-if-in-editor"
              ></span>
              below<span class="block-component"></span>.</span
            ></span
          ></span
        >
      </div>
      ...
      <div style="line-height: 1.5">
        <span style="font-size: 15px"
          ><span data-custom-class="body_text"
            ...
            the processing before its withdrawal nor,<span
              class="block-component"
            ></span>
            when applicable law allows,<span
              class="statement-end-if-in-editor"
            ></span>
            will it affect the processing of your personal information conducted
            in reliance on lawful processing grounds other than consent.<span
              class="block-component"
            ></span></span></span
        ><span class="block-component"
          ><span style="font-size: 15px"
      ...
      <div style="line-height: 1.5">
        <span data-custom-class="body_text"
          ><span style="font-size: 15px"
            ...
            in your account or terminate your account, you can:<span
              class="forloop-component"
            ></span></span
        ></span>
      </div>
      ...
      <div style="line-height: 1.5">
        <span data-custom-class="body_text"
          ><span style="font-size: 15px"
            ...
            may email us at
            <span class="question">first.bite.app@gmail.com</span>.</span
          ></span
        ><span class="statement-end-if-in-editor"
          ><span style="font-size: 15px"
            ><span data-custom-class="body_text"></span></span
        ...
        <span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              applications include a Do-Not-Track (<span
                class="block-component"
              ></span
              >"DNT"<span class="statement-end-if-in-editor"></span>) feature or
              ...
              <span class="block-component"></span>recognizing<span
                class="statement-end-if-in-editor"
              ></span>
              and implementing DNT signals has been
              <span class="block-component"></span>finalized<span
                class="statement-end-if-in-editor"
              ></span
        ...
        <span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              <span class="block-component"></span>"Shine The Light"<span
                class="statement-end-if-in-editor"
              ></span>
        ...
        <span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              (e.g.<span class="block-component"></span>,<span
                class="statement-end-if-in-editor"
              ></span>
              backups, etc.).<span
                style="color: rgb(89, 89, 89); font-size: 15px"
                ...
                ><span style="font-size: 15px; color: rgb(89, 89, 89)"
                  ><span style="font-size: 15px; color: rgb(89, 89, 89)"
                    ><span data-custom-class="body_text"
                      ...
                      <span class="block-component"></span>"resident"<span
                        class="statement-end-if-in-editor"
                      ></span>
                      as:</span
                    ></span
        ...
        <span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              than a temporary or transitory purpose and</span
            ></span
          ></span
        >
      </div>
        ...
        <span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              <span class="block-component"></span>"non-residents."<span
                class="statement-end-if-in-editor"
              ></span></span></span
        ></span>
      </div>
                ...
                <span style="font-size: 15px; color: rgb(89, 89, 89)"
                  ><span style="font-size: 15px; color: rgb(89, 89, 89)"
                    ><span data-custom-class="body_text"
                      ...
                      address, email address, and account name</span
                    ></span
                  ></span
                >
              </div>
                ...
                <span style="font-size: 15px; color: rgb(89, 89, 89)"
                  ><span style="font-size: 15px; color: rgb(89, 89, 89)"
                    ><span data-custom-class="body_text"
                      ...
                      details, and payment information</span
                    ></span
                  ></span
                >
              </div>
            ...
            >
              ...
              <div data-custom-class="body_text" style="line-height: 1.5">
                <span class="forloop-component"
                  ><span data-custom-class="body_text"></span></span
                ><span class="block-component"></span
                ><span class="block-component"></span>NO<span
                  class="statement-end-if-in-editor"
                  ><span data-custom-class="body_text"></span
                ></span>
              </div>
                ...
                <span style="font-size: 15px; color: rgb(89, 89, 89)"
                  ><span style="font-size: 15px; color: rgb(89, 89, 89)"
                    ><span data-custom-class="body_text"
                      ...
                      <span class="block-component"></span>behavior<span
                        class="statement-end-if-in-editor"
                      ></span
                      >, interest data, and interactions with our and other
                      websites, applications, systems, and advertisements</span
                    ></span
                  ></span
                >
              </div>
          ...
          <tr>
            ...
            >
              ...
              ><span data-custom-class="body_text"
                ><span class="forloop-component"></span
                ><span class="block-component"></span
                ><span class="question">Sex life or sexual orientation</span
                ><span class="else-block"></span
                ><span class="forloop-component"></span
                ><span class="block-component"></span>,
                <span class="question">account login information</span
                ><span class="else-block"></span
                ><span class="forloop-component"></span
                ><span class="block-component"></span> and
                <span class="question">debit or credit card numbers</span
                ><span class="statement-end-if-in-editor"></span
                ><span class="forloop-component"></span></span
              ><span class="statement-end-if-in-editor"
                ><span data-custom-class="body_text"></span
      ...
      <div style="line-height: 1.5">
        ...
        ><span data-custom-class="body_text"
          ...
          to provide the Services or for:<span class="block-component"></span
        ></span>
      </div>
      <ul>
        <li style="line-height: 1.5">
          <span data-custom-class="body_text"
            >Category A -
            <span class="question"
              >As long as the user has an account with us</span
            ><span class="statement-end-if-in-editor"></span
          ></span>
        </li>
      </ul>
      ...
      <div style="line-height: 1.5">
        <span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ><span class="block-component"></span>Category L information may
              be used, or disclosed to a service provider or contractor, for
              additional, specified purposes. You have the right to limit the
              use or disclosure of your sensitive personal information.</span
            ></span
          ></span
        >
      </div>
              ...
              ><span style="font-size: 15px; color: rgb(89, 89, 89)"
                ><span style="font-size: 15px; color: rgb(89, 89, 89)"
                  ><span data-custom-class="body_text"
                    ...
                    practices can be found in this privacy notice<span
                      class="block-component"
                    ></span
                    >.</span
                  ></span
        ...
        <span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              strict privacy protection obligations mandated by the CCPA.</span
            ></span
          ></span
        >
      </div>
      ...
      <span data-custom-class="body_text">
        <span style="font-size: 15px">
          <span class="question">The FirstBite</span>
          has not sold or shared any personal information to third parties for a
      ...
      <span style="font-size: 15px">
        <span style="color: rgb(89, 89, 89)">
          <span style="color: rgb(89, 89, 89)">
            ...
            <span data-custom-class="body_text">
              has disclosed the following categories of personal information to
      ...
      <div style="line-height: 1.5">
        <span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ><u>Right to be informed — Request to know</u></span
            ></span
          ></span
        >
      </div>
        ...
        <span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              to verify a consumer request.</span
            ></span
          ></span
        >
      </div>
      ...
      <div style="line-height: 1.5">
        <span data-custom-class="body_text"
          ...
          sensitive personal information for additional purposes.</span
        >
      </div>
      <div style="line-height: 1.5">
        <span data-custom-class="body_text"><br /></span>
        ...
        <span style="font-size: 15px; color: rgb(89, 89, 89)">
          <span style="font-size: 15px; color: rgb(89, 89, 89)">
            <span data-custom-class="body_text">
              ...
              may contact you through a communication method (e.g.
              <span class="block-component"></span>
              ,
              <span class="statement-end-if-in-editor"></span>
        ...
        <span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              provided information as soon as we finish verifying you.</span
            ></span
          ></span
        >
      </div>
          ...
          <span style="font-size: 15px; color: rgb(89, 89, 89)">
            <span style="font-size: 15px; color: rgb(89, 89, 89)">
              <span data-custom-class="body_text">
                ...
                authorized
                <span class="statement-end-if-in-editor"></span>
                agent to make a request under the CCPA on your behalf. We may
      ...
      <div style="line-height: 1.5">
        <span id="virginia" style="font-size: 15px"
          ><strong
            ><span data-custom-class="heading_1"
              >11. DO VIRGINIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</span
            ></strong
      ...
      <div style="line-height: 1.5">
        <span style="font-size: 15px"
          ><em
            ><strong
              ><span data-custom-class="body_text">In Short:</span></strong
            ><span data-custom-class="body_text">
      ...
      <div style="line-height: 1.5">
        <span style="font-size: 15px"
          ><strong
            ><span data-custom-class="heading_2"
              >Virginia CDPA Privacy Notice</span
            ></strong
          ></span
        >
      </div>
      ...
      <div style="line-height: 1.5">
        <span style="font-size: 15px"
          ><span data-custom-class="body_text"
            >Under the Virginia Consumer Data Protection Act (CDPA):</span
          ></span
        >
      </div>
      <div style="line-height: 1.5">
      ...
      <div style="line-height: 1.5">
        <span style="font-size: 15px"
          ><span data-custom-class="body_text"
            ><span class="block-component"></span>"Consumer"<span
              class="statement-end-if-in-editor"
            ></span>
            ...
            natural person acting in a commercial or employment context.</span
          ></span
        >
      </div>
      <div style="line-height: 1.5">
      ...
      <div style="line-height: 1.5">
        <span style="font-size: 15px"
          ><span data-custom-class="body_text"
            ><span class="block-component"></span>"Personal data"<span
              class="statement-end-if-in-editor"
            ></span>
      ...
      <div style="line-height: 1.5">
        <span style="font-size: 15px"
          ><span data-custom-class="body_text"
            ><span class="block-component"></span>"Sale of personal data"<span
              class="statement-end-if-in-editor"
            ></span>
      ...
      <div style="line-height: 1.5">
        <span style="font-size: 15px"
          ><span data-custom-class="body_text"
            ...
            <span class="question">The FirstBite</span> and our Services. To
            find out more, please visit the following links:</span
          ><span class="block-component"></span
        ></span>
      </div>
      <ul>
      ...
      <ul>
        <li style="line-height: 1.5">
          <span style="font-size: 15px"
            ><a data-custom-class="link" href="#infouse"
              >How we use your personal data</a
            ><span class="statement-end-if-in-editor"></span
          ></span>
        </li>
      </ul>
      ...
      <ul>
        <li style="line-height: 1.5">
          <span style="font-size: 15px"
            ><a data-custom-class="link" href="#whoshare"
              >When and with whom we share your personal data</a
            ><span class="statement-end-if-in-editor"></span
          ></span>
        </li>
      </ul>
      <div style="line-height: 1.5">
        <span style="font-size: 15px"
          ><u
            ><span data-custom-class="body_text"
              >Your rights with respect to your personal data</span
            ></u
          ></span
        >
      </div>
        ...
        <li style="line-height: 1.5">
          <span style="font-size: 15px"
            ><span data-custom-class="body_text"
              ...
              similarly significant effects (<span
                class="block-component"
              ></span
              >"profiling"<span class="statement-end-if-in-editor"></span
              >)</span
            ></span
          ><span class="statement-end-if-in-editor"
            ><span style="font-size: 15px"></span
      ...
      <div data-custom-class="body_text" style="line-height: 1.5">
        <span data-custom-class="body_text" style="font-size: 15px"
          ><span class="block-component"></span
          ><span class="question">The FirstBite</span> sells personal data to
          third parties or processes personal data for targeted advertising.
          Please see the following section to find out how you can opt out from
          further selling or sharing of your personal data for targeted
          advertising or profiling purposes.<span
            class="statement-end-if-in-editor"
          ></span
        ></span>
      </div>
      ...
      <div style="line-height: 1.5">
        <u
          ><span data-custom-class="body_text" style="font-size: 15px"
            >Exercise your rights provided under the Virginia CDPA</span
          ></u
        >
      </div>
      <div style="line-height: 1.5"><br /></div>
      <div style="line-height: 1.5">
        <span data-custom-class="body_text" style="font-size: 15px"
          ...
          be found in this privacy notice<span class="block-component"></span
          >.</span
        >
      </div>
      <div style="line-height: 1.5"><br /></div>
      <div style="line-height: 1.5">
        ...
        ><span style="font-size: 15px"
          ><span data-custom-class="body_text"
            ...
            <span class="question">first.bite.app@gmail.com</span>,
            <span class="block-component"></span>by visiting our </span
          ><a
            href="https://app.termly.io/notify/9afc2671-eae5-4301-8a71-64a337c9ec80"
            rel="noopener noreferrer"
            target="_blank"
            ><span data-custom-class="link">data subject request form</span></a
          ><span data-custom-class="body_text"
            ><span class="block-component"></span>, or by referring to the
      ...
      <div style="line-height: 1.5">
        <span style="font-size: 15px"
          ><span data-custom-class="body_text"
            >If you are using an
            <span class="block-component"></span>authorized<span
              class="statement-end-if-in-editor"
            ></span>
            agent to exercise your rights, we may deny a request if the
            <span class="block-component"></span>authorized<span
              class="statement-end-if-in-editor"
            ></span>
            agent does not submit proof that they have been validly
      ...
      <div style="line-height: 1.5">
        <span style="font-size: 15px"
          ><span data-custom-class="body_text"
            ...
            identity before processing your request.</span
          ></span
        >
      </div>
      <div style="line-height: 1.5"><br /></div>
      <div style="line-height: 1.5">
        <span style="font-size: 15px"
          ><span data-custom-class="body_text"
            ...
            the reason for the extension.</span
          ></span
        >
      </div>
      <div style="line-height: 1.5"><br /></div>
      <div style="line-height: 1.5">
        <span style="font-size: 15px"
          ><u
            ><span data-custom-class="body_text">Right to appeal</span></u
          ></span
        >
      </div>
      <div style="line-height: 1.5">
      ...
      <div style="line-height: 1.5">
        <span style="font-size: 15px"
          ><span data-custom-class="body_text"
            ...
            you of our decision and reasoning behind it. </span
          ><span data-custom-class="body_text"
            >If you wish to appeal our decision, please email us at
            <span class="block-component"></span
            ><span class="question">first.bite.app@gmail.com</span
            ><span class="else-block"></span>. Within sixty (60) days of receipt
        ...
        ><a
          ...
          target="_blank"
          ><span style="font-size: 15px"
            ><span data-custom-class="link">submit a complaint</span></span
          ></a
        ><span style="font-size: 15px"
          ><span data-custom-class="body_text">.</span
          ><span class="statement-end-if-in-editor"></span
        ...
        <span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              <span class="block-component"></span>"Revised"<span
                class="statement-end-if-in-editor"
              ></span>
        ...
        <span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              <span style="color: rgb(89, 89, 89); font-size: 15px"
                ><span data-custom-class="body_text"
                  ><span class="block-component"></span>email us at
                  <span class="question">first.bite.app@gmail.com</span
                  ><span class="statement-end-if-in-editor"></span></span></span
              ><span style="font-size: 15px; color: rgb(89, 89, 89)"
                ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ...
            ><span data-custom-class="body_text"
              ><span style="font-size: 15px"
                ><span style="color: rgb(89, 89, 89)"
                  ><span style="color: rgb(89, 89, 89)"
                    ><span data-custom-class="body_text"
                      ><span class="question">The FirstBite</span></span
                    ></span
                  ></span
                ></span
              ></span
      ...
      <div style="line-height: 1.5">
        <span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ><span class="block-component"></span>You have the right to
              request access to the personal information we collect from you,
              change that information, or delete it.
              <span class="statement-end-if-in-editor"></span>To request to
              review, update, or delete your personal information, please
              <span class="block-component"></span>submit a request form by
              clicking </span
            ><span style="color: rgb(48, 48, 241)"
              ><span data-custom-class="body_text"
                ><span style="font-size: 15px"
              ...
              ></span
            ><span class="block-component"
              ><span data-custom-class="body_text"></span></span></span></span
        ><span data-custom-class="body_text">.</span>
      </div>
      <div
        style="
